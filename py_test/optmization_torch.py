    ...
    def closure():
        ...
        if random_shuffle:
            if not view_dependent:
                ...
                view_dirs,view_theta,all_locations_cube,all_locations = torch_util.sample_view_dependent_location(n_sample_per_level, rng, no_parallel=True, cos_theta_max=1)
            #new parameter
